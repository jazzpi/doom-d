...
;; We need to remove this module from doom-modules or the next doom! call will
;; try loading it again, leading to a recursive load
(remhash '(:private . jazzpi) doom-modules)
